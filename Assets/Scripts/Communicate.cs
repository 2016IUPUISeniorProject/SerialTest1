...
public class Communicate : MonoBehaviour {
	...
	void Update () {
		...
		try{
			...
			if(STRINGFROMBOX=="b0")
            {
                Debug.Log("b Status 0 from Box");           /// copy this one
